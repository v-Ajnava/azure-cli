...
class MainCommandsLoader(CLICommandsLoader):
    ...
    def load_command_table(self, args):
        ...
        def _update_command_table_from_modules(args, module_name=None):
            ...
            if module_name and module_name not in BLACKLISTED_MODS:
                try:
                    _load_module_command_loader(self, args, module_name)
...
class AzCommandsLoader(CLICommandsLoader):
    ...
    def get_sdk(self, *attr_args, resource_type=None, **kwargs):
        from azure.cli.core.profiles import get_sdk
        return get_sdk(self.cli_ctx, resource_type or self.module_kwargs['resource_type'], *attr_args, **kwargs)

    def get_models(self, *attr_args, resource_type=None):
        resource_type = resource_type or self.module_kwargs.get('resource_type', None)
        from azure.cli.core.profiles import get_sdk
    ...
    def _cli_command(self, name, operation=None, handler=None, argument_loader=None, description_loader=None, **kwargs):
        ...
        def default_arguments_loader():
            ...
            if doc_string_source:
                op.__doc__ = doc_string_source.__doc__
