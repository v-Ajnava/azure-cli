...
class EventhubCommandsLoader(AzCommandsLoader):
    ...
    def __init__(self, cli_ctx=None):
        ...
        eventhub_custom = CliCommandType(operations_tmpl='azure.cli.command_modules.eventhub.custom#{}')
    ...
    def load_command_table(self, args):
        from azure.cli.command_modules.eventhub.commands import load_command_table
        load_command_table(self, args)
        return self.command_table

    def load_arguments(self, command):
        from azure.cli.command_modules.eventhub._params import load_arguments_namespace, load_arguments_eventhub, load_arguments_consumergroup, load_arguments_geodr
